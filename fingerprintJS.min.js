...
return{componentsToDebugString:Mn,default:Yn,getFullscreenElement:A,getUnstableAudioFingerprint:J,getUnstableCanvasFingerprint:U,getUnstableScreenFrame:en,getUnstableScreenResolution:q,getWebGLContext:wn,hashComponents:Rn,isAndroid:N,isChromium:j,isDesktopWebKit:P,isEdgeHTML:Y,isGecko:E,isTrident:I,isWebKit:X,load:In,loadSources:G,murmurX64Hash128:jn,prepareForSources:Gn,sources:Zn,transformSource:F,withIframe:D};
})();
